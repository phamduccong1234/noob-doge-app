...
const { AdminController, ProductController, ClientController, AjaxController} = require("../apps/controllers");
...
router.route("/admin/products/edit/:id").get(ProductController.edit).post(upload.single("prd_image"), ProductController.update);

router.get("/admin/products", ProductController.index);

router.get("/admin/product/delete/:id", ProductController.destroy);

router.route("/admin/products/add").get(ProductController.add).post(upload.single("prd_image"), ProductController.store);
